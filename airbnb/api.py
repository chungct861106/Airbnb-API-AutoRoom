...
class Api(object):
    ...
    def __init__(self, username=None, password=None, access_token=None, api_key=API_KEY, session_cookie=None,
        ...
        self._session.headers = {
            ...
            "x-airbnb-currency": "TWD",
            "x-airbnb-locale": "zh",
            "x-airbnb-carrier-country": "TW",
    ...
    @randomizable
    def get_homes(self, query=None, gps_lat=None, gps_lng=None, checkin=None, checkout=None, adults=None, offset=0, items_per_grid=8):
        """
